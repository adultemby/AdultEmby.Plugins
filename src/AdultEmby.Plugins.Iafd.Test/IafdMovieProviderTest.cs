...
{
    public class IafdMovieProviderTest
    {
        //private const string BaseUrl = "http://www.hotmovies.com/";
        private const string AnalLessons1Id = "title=Anal+Lessons+1/year=2012";
        ...
        public async void ShouldRetrieveMetadataViaSearchIfIdIsUnknown()
        {
            ...
            IafdMovieProvider metadataProvider =
                new IafdMovieProvider(httpClient, ConfigurationManager(), fileSystem, LogManager(), JsonSerializer());
        ...
        public async void ShouldRetrieveMetadataDirectlyIfIdIsKnown()
        {
            ...
            MovieInfo movieInfo = new MovieInfo();
            movieInfo.ProviderIds.Add(IafdMovieId.KeyName, AnalLessons1Id);
        ...
        public async void ShouldSearchUsingIdIfSupplied()
        {
            ...
            searchInfo.SetProviderId(IafdMovieId.KeyName, AnalLessons1Id);
            ...
            Assert.Equal("title=Anal+Lessons+1/year=2012", searchResult1993.GetProviderId(IafdMovieId.KeyName));
        ...
        {
            Assert.Equal(id, person.GetProviderId(IafdPersonId.KeyName));
        ...
        {
            //"http://www.iafd.com/title.rme/215223"
            return IafdConstants.BaseUrl + "title.rme/" + movieId;
        }
        ...
        private string UrlForSearch(string searchTerms)
        {
            ...
            // "http://www.iafd.com/title.rme/title=Anal+Lessons+1/year=2012"
            return IafdConstants.BaseUrl + "search.php?view_style=classic&page=1&search_string=" + WebUtility.UrlEncode(searchTerms);
        }
