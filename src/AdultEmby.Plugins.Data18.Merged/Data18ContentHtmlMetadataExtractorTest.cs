...
using MediaBrowser.Plugins.Data18;
using NSubstitute;
using Xunit;
...
namespace AdultEmby.Plugins.Test.Data18
{
    public class Data18ContentHtmlMetadataExtractorTest
    {
        ...
        public void ShouldUseSiteIfPresentWhenExtractingStudio()
        {
            ...
            String studio = htmlMetadataExtractor.GetStudio(LoadHtmlDocument(@"TestResponses\Data18\ContentWithStudioResponse.html"));
        ...
        public void ShouldExtractActorsUsingStaringBulletIfWhosWhoSectionIsNotPresent()
        {
            ...
            List<MoviePerson> actors = htmlMetadataExtractor.GetActors(LoadHtmlDocument(@"TestResponses\Data18\ContentWithoutWhosWhoResponse.html"));
        ...
        {
            return LoadHtmlDocument(@"TestResponses\Data18\ContentResponse.html");
        }
